...
function ExtensionCard({ ext }: { ext: ExtensionData }) {
  return (
    <article id={`extension-${ext.number}`} className="border border-[rgba(0,0,0,0.1)] rounded-lg bg-cream overflow-hidden">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 p-8 lg:p-12">
        {/* Left: identity + CTA */}
        ...
        {/* Right: feature grid */}
        <div className="lg:col-span-7 lg:border-l lg:border-[rgba(0,0,0,0.08)] lg:pl-12">
          <span className="uppercase tracking-widest text-slate block mb-5" style={tx.eyebrow}>
            What it does
          </span>
